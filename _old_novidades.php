...
$title = 'Novidades';
$description = 'Acompanhe os últimos logs e novidades da Commit Crimes. De bugs corrigidos a novas funcionalidades que não deveriam existir.';
                    ...
                    <div style="padding: 1rem; border-top: 1px solid #2c3e50;">
                        <div style="color: #adb5bd; font-family: var(--font-mono); font-size: 0.85rem;">
                            <div style="margin-bottom: 0.5rem;">
                                📊 <span style="color: #27ca3f;">Logs loaded:</span> <?= count($logs) ?> entries
                            </div>
                            <div style="margin-bottom: 0.5rem;">

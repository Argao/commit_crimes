...
$current_page = 'sobre';
$title = 'Sobre';
$description = 'Porque fazer certo é opcional, mas fazer funcionar é obrigação. Conheça a história da Commit Crimes e nossa equipe de especialistas em caos controlado.';
    ...
    <div class="container">
        ...
        <div class="about-content">
            ...
            <div class="about-image">
                <img src="assets/img/stressed-dev.jpg" alt="A origem de tudo: dev estressado tentando fazer funcionar" class="hero-image">
            </div>
        </div>
        ...
        <div style="text-align: center; margin: 4rem 0; padding: 3rem; background: #f8f9fa; border-radius: 1rem;">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                ...
                <a href="novidades" class="btn btn-outline">Últimas Novidades</a>
            </div>
        </div>
    </div>
</section>

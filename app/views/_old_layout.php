...
<body>
    ...
    <header class="header">
        <nav class="navbar">
            <a href="index" class="logo">Commit Crimes™</a>
            
            <ul class="nav-menu" id="nav-menu">
                <li><a href="index" class="nav-link <?= $current_page === 'index' ? 'active' : '' ?>">Início</a></li>
                <li><a href="sobre" class="nav-link <?= $current_page === 'sobre' ? 'active' : '' ?>">Sobre</a></li>
                <li><a href="servicos" class="nav-link <?= $current_page === 'servicos' ? 'active' : '' ?>">Serviços</a></li>
                <li><a href="novidades" class="nav-link <?= $current_page === 'novidades' ? 'active' : '' ?>">Novidades</a></li>
            </ul>

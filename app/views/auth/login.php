    ...
    <div class="container">
        <div style="max-width: 500px; margin: 0 auto;">
            ...
            <div style="background: #0f0f0f; border-radius: 0.5rem; padding: 0; box-shadow: var(--shadow-lg);">
                ...
                <div style="padding: 2rem; font-family: var(--font-mono);">
                    ...
                    <?php if (isset($errors) && !empty($errors)): ?>
                        <div style="color: #ff5f56; margin-bottom: 1rem; line-height: 1.5;">
                            <div>[ERROR] Validation failed:</div>
                    ...
                    <?php if (isset($error)): ?>
                        <div style="color: #ff5f56; margin-bottom: 1rem; line-height: 1.5;">
                            <div>[ERROR] <?= View::e($error) ?></div>
                        </div>
                    <?php endif; ?>

                    <!-- Login Form -->
                    <form method="POST" action="<?= View::url('login') ?>" style="margin-bottom: 1rem;">
                        <div style="margin-bottom: 1rem;">
                            ...
                            <input 
                                ...
                                value="<?= isset($old['username']) ? View::e($old['username']) : '' ?>"
                            >
                        </div>
            ...
            <div style="text-align: center; margin-top: 3rem;">
                <a href="<?= View::url() ?>" class="btn btn-outline">← Voltar ao Site</a>
            </div>
        </div>
    </div>
</section> 